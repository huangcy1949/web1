...
export default class EditPage extends Component {
    ...
    handleSyncListPageFields = () => {
        ...
        const values = listPageFieldsValue.map(item => ({...item, id: uuid()}));
        this.props.form.setFieldsValue({fields: values});
    };
                    ...
                    <EditableTable
                        ...
                        title={() => {
                            ...
                            return (
                                <div>
                                    表单字段：
                                    <Popconfirm title="以下表单字段将被覆盖，是否同步？" onConfirm={this.handleSyncListPageFields} okText="确定" cancelText="取消">
